...
rsync -avxz ~/.tidyrc /Volumes/SANDISK/mobilePerl/.tidyrc
rsync -avxz ~/.vimrc /Volumes/SANDISK/mobilePerl/.vimrc
...
rsync -avxz ~/Documents/git/ /Volumes/SANDISK/mobilePerl/git
