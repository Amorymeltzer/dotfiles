...
#export LSCOLORS='di=1:fi=0:ln=31:pi=5:so=5:bd=5:cd=5:or=31:mi=0:ex=35:*.rb=90'  #LS_COLORS is not supported by the default ls command in OS-X
...
_explain_perlcritic()		# ;;;;;; ##### FIXME TODO
{
    ...
    local list="$(\ls /opt/local/share/perl5.24/siteman/man3/Perl\:\:Critic\:\:Policy\:\:*)"
...
alias dgc="cd ~/Documents/git/homebrew/Library/Taps/homebrew/homebrew-cask"
alias dgm="cd ~/Documents/git/mls"
alias dgs="dgm"
