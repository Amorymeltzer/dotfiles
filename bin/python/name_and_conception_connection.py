...
##                                              ##
## Modified by Amory Meltzer, December 2013     ##
## Report naming influences as well             ##
##                                              ##
##################################################
...
def main():
	...
	while True:
		...
		try:
			...
			event = get_event(conception)
			print "Most likely historical event that aroused your parents:"
			print ("--> " + event)

                        molly = get_event(birthday)
			print "Most likely historical event that named yous:"
			print ("--> " + molly)
